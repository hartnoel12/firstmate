...
- [docs/verification/merge-verification-gate.md](docs/verification/merge-verification-gate.md) - active maintainer verification for the refusal to merge a commit with no local verification evidence.
